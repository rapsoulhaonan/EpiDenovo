<?php
include("loginserv.php"); //Include login for checking username and password
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="login">
    ...
    <form action="" method="post">
        ...
        <button type="submit" id="btn" name="submit" value="Login" class="btn btn-primary btn-block btn-large">Let me in.</button>
    </form>
</div>
